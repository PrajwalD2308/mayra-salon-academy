    ...
    services: [
      {
        id: "normal-facial",
        name: "Normal Facial",
        description: "Basic facial for clean and refreshed skin",
        price: "₹800",
        benefits: [
          "Cleanses skin",
          "Improves freshness",
      ...
      {
        id: "raaga-dry-oily-facial",
        name: "Raaga Dry / Oily Facial",
        description: "Customized facial for dry or oily skin",
        price: "₹1500",
        benefits: [
          "Balances skin type",
          "Improves texture",
      ...
      {
        id: "hydra-facial-arganine",
        name: "Hydra Facial with Arginine Peel",
        description: "Hydration-boost facial with arginine peel",
        price: "₹3000",
        benefits: [
          "Deep hydration",
      ...
      {
        id: "skin-polishing-glow-facial",
        name: "Skin Polishing Glow Facial",
        description: "Glow-enhancing facial with polishing effect",
        price: "₹499",
        benefits: [
          "Instant glow",
          "Smooth skin",
      ...
      {
        id: "kanpeki-cleanup",
        name: "Kanpeki CleanUp",
        description: "Deep clean-up using Kanpeki products",
        price: "₹1500",
        benefits: [
          "Deep pore cleansing",
      ...
      },
      {
        id: "kanpeki-facial",
        name: "Kanpeki Facial",
        description: "Premium facial treatment with Kanpeki range",
        price: "₹4000",
        benefits: [
          "Advanced skin care",
          "Brightens skin tone",
      ...
      {
        id: "kanpeki-save-the-date",
        name: "Kanpeki Save the Date",
        description: "Pre-event facial for flawless skin",
        price: "₹6000",
        benefits: [
          "Event-ready skin",
          "Deep nourishment",
      ...
      {
        id: "brillare-facial",
        name: "Brillare Facial",
        description: "Facial for oil control, brightening and age revival",
        price: "₹3000",
        benefits: [
          "Oil control",
          "Skin brightening",
      ...
      {
        id: "brillare-facial-advance",
        name: "Brillare Facial Advance Peel Programme",
        description: "Advanced peel program for skin rejuvenation",
        price: "₹4000",
        benefits: [
